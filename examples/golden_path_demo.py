...
from decision_layer.dsl_formal import DSLParser, DSLStaticAnalyzer, RuleConflictError, UnreachableRuleError
...
class GoldenPathDemo:
    ...
    async def step_1_bootstrap(self):
        ...
        self.demo_data["bootstrap"] = {
            ...
            "components": ["decision_engine", "time_manager", "feature_store", "release_manager"]
        }
    ...
    async def step_2_register_function(self):
        ...
        @df_pure
        def loan_approval_decision(input_data: Dict[str, Any], context: Any) -> Dict[str, Any]:
            ...
            approved = (
                amount <= 100000 and  # Max loan amount
                credit_score >= 650 and  # Min credit score
                income >= amount * 0.3  # Income requirement
            )
            ...
            return {
                ...
                "reason": "Meets all criteria" if approved else "Credit score or income insufficient",
    ...
    async def step_3_run_tests(self):
        ...
        test_cases = [
            # Approved cases
            {"amount": 50000, "credit_score": 750, "income": 80000, "customer_id": "CUST001"},
            {"amount": 25000, "credit_score": 700, "income": 60000, "customer_id": "CUST002"},
            
            # Rejected cases
            {"amount": 150000, "credit_score": 600, "income": 100000, "customer_id": "CUST003"},
            {"amount": 50000, "credit_score": 500, "income": 80000, "customer_id": "CUST004"},
            {"amount": 50000, "credit_score": 750, "income": 10000, "customer_id": "CUST005"},
            
            # Edge cases
            {"amount": 100000, "credit_score": 650, "income": 30000, "customer_id": "CUST006"},
            {"amount": 0, "credit_score": 800, "income": 100000, "customer_id": "CUST007"},
            {"amount": 1, "credit_score": 649, "income": 100000, "customer_id": "CUST008"},
        ]
            ...
            "rules": [
                {
                    ...
                    "actions": [
                        {"action_type": "set", "field": "amount_approved", "value": True}
                    ],
    ...
    async def step_4_deploy_api(self):
        ...
        test_requests = [
            {"amount": 50000, "credit_score": 750, "income": 80000, "customer_id": "CUST001"},
            {"amount": 150000, "credit_score": 600, "income": 100000, "customer_id": "CUST002"},
        ]
    ...
    async def step_5_emit_traces(self):
        ...
        test_cases = [
            {"amount": 50000, "credit_score": 750, "income": 80000, "customer_id": "CUST001"},
            {"amount": 150000, "credit_score": 600, "income": 100000, "customer_id": "CUST002"},
            {"amount": 25000, "credit_score": 700, "income": 60000, "customer_id": "CUST003"},
        ]
    ...
    async def step_6_run_rollback(self):
        ...
        @df_pure
        def problematic_loan_approval(input_data: Dict[str, Any], context: Any) -> Dict[str, Any]:
