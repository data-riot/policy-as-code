...
from policy_as_code.ledger_postgres import create_postgresql_ledger
from policy_as_code.release import create_release_manager
...
async def setup_governance_services():
    ...
    db_url = os.getenv(
        "DATABASE_URL", "postgresql://postgres:password@localhost:5432/policy_as_code"
    )
