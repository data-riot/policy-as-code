...
from .legal_refs import LawReference, validate_legal_references_in_metadata
...
class DecisionFunctionSpec:
    ...
    def _validate_legal_references(self) -> None:
        ...
        for ref in self.legal_references:
            ...
            if not validate_legal_references_in_metadata([ref]):
                raise DecisionLayerError(
                    "invalid_legal_reference",
                    f"Invalid legal IRI: {ref.iri}. Must be valid Finlex or EUR-Lex reference",
                )
