...
# Policy as Code - Temporal Policy Query via CLI
# This script demonstrates how to query for policies active in April 2017 using the CLI

echo "🚀 Policy as Code - Temporal Policy Query via CLI"
echo "=================================================="
...
policy-as-code list --detailed --format json > functions_list.json
...
for function in functions:
    ...
    try:
        result = subprocess.run(
            ['policy-as-code', 'info', function_id, '--format', 'json'],
...
for policy in active_policies:
    ...
    try:
        ...
        result = subprocess.run([
            'policy-as-code', 'traces', function_id,
